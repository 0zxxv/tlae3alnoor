...
export const ParentChat: React.FC = () => {
  ...
  // Get users to chat with (teachers, admins - excluding self and other parents)
  const chatUsers = mockUsers.filter((u) => u.id !== user?.id && u.role !== 'parent');
